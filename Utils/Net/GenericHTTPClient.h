...
public:					
    ...
    PBYTE QueryHTTPResponseHeader(){
        return (PBYTE)_szHTTPResponseHeader;
    };
    PBYTE QueryHTTPResponse(DWORD &dwResLength) {
        dwResLength = _dwHTTPResponseHtmlLen;
        return (PBYTE)_szHTTPResponseHTML;
    };
